  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "kovacs-david": "hsl(var(--kovacs-david))",
        "pal-greta": "hsl(var(--pal-greta))",
        "fazekas-eszter": "hsl(var(--fazekas-eszter))",
        custom: "hsl(var(--custom))",
        ko: "hsl(var(--ko))",
        "nadler-balazs": "hsl(var(--nadler-balazs))",
        "nadler-somogyi-laura": "hsl(var(--nadler-somogyi-laura))",
        "teki-teknos": "hsl(var(--teki-teknos))",
        kenvo: "hsl(var(--kenvo))",
        "bata-botond": "hsl(var(--bata-botond))",
        bennet: "hsl(var(--bennet))",
        "budai-imre": "hsl(var(--budai-imre))",
