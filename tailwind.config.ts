  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "sulyok-csanad": "hsl(var(--sulyok-csanad))",
        "csonno-balint": "hsl(var(--csonno-balint))",
        "kovari-daniella": "hsl(var(--kovari-daniella))",
        "nemecz-levente": "hsl(var(--nemecz-levente))",
        "rampasek-attila": "hsl(var(--rampasek-attila))",
        "barath-barnabas": "hsl(var(--barath-barnabas))",
        "koban-laci": "hsl(var(--koban-laci))",
        "pinter-zsombor": "hsl(var(--pinter-zsombor))",
        koronczai: "hsl(var(--koronczai))",
        "bocskay-tanarano": "hsl(var(--bocskay-tanarano))",
        "gyurik-pal": "hsl(var(--gyurik-pal))",
        "cseh-balazs": "hsl(var(--cseh-balazs))",
        "albrecht-laszlo": "hsl(var(--albrecht-laszlo))",
        "bery-balogh": "hsl(var(--bery-balogh))",
        "keresztes-kornel": "hsl(var(--keresztes-kornel))",
        "szabo-zoard": "hsl(var(--szabo-zoard))",
        zsonyi: "hsl(var(--zsonyi))",
        papszicsu: "hsl(var(--papszicsu))",
        "krein-sebastyen": "hsl(var(--krein-sebastyen))",
        "lubrincz-gergo": "hsl(var(--lubrincz-gergo))",
